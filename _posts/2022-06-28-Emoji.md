...
As humans from different background begin using emojis in various situations, emojis obtain a multi-facet meaning:
...
Yet the cultural construct aspect of emojis proposes new challenges for judges. They have to decipher the meaning behind those one-character emojis to grasp the intention behind those colorful pictograms.
...
The rapid-changing emojis have impeded the judgments in court. If emoji were to function as an evidence, discriminating
the inherent definition becomes an emerging problem. The existing emojipedia is far from satisfaction, as it provides explanations
...
One time when I send a meme to my American friend, he replied to me with "funny 🙂".
...
We can observe several clusters including a cluster of national flags, a cluster of digits and a cluster of laughing faces, etc.
Yet such a pattern is not universal,
as found by Japanese researchers at the University of Tsukuba <d-cite key="tomihira2020multilingual"></d-cite>.
They conduct similar experiments on Japanese social media and found that laughing is not tightly close <d-footnote>
